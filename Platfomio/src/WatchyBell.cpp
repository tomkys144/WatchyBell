...
void WatchyBell::drawWatchFace()
{
    ...
    display.fillRoundRect(0, 0, DISPLAY_WIDTH, DISPLAY_HEIGHT, 8, DARKMODE ? GxEPD_BLACK : GxEPD_WHITE);
...
void WatchyBell::drawInfo()
{
    ...
    display.fillRoundRect(SPACING, current_y - h - 2, w + 8, h + 4, 2, DARKMODE ? GxEPD_WHITE : GxEPD_BLACK);
...
void WatchyBell::drawBattery()
{
    ...
    display.fillRoundRect(SPACING, SPACING, BATTERY_WIDTH, BATTERY_HEIGHT, BATTERY_SPACING, DARKMODE ? GxEPD_WHITE : GxEPD_BLACK);
    display.fillRoundRect(SPACING + BATTERY_SPACING, SPACING + BATTERY_SPACING, BATTERY_WIDTH - (2 * BATTERY_SPACING), BATTERY_HEIGHT - (2 * BATTERY_SPACING), BATTERY_SPACING / 2, DARKMODE ? GxEPD_BLACK : GxEPD_WHITE);
